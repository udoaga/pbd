...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2021 at 03:56 AM
...
(1, '000000', 'unknown', '-'),
(2, '000001', 'Manajemen Informatika', 'B');
...
--
ALTER TABLE `dt_prodi`
  MODIFY `idprodi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
